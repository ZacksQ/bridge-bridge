...
const ExpandableTree = ({treeData, defaultExpandAll, defaultExpandLevel, keyProp, labelProp, ...restProps}) => {
    //组件状态
    ...
    //渲染
    return (
        <Tree treeData={treeData} expandedKeys={mutableExpandKeys} onExpand={handleExpand} {...restProps}/>
    )
};
